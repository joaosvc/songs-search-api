...
export type PipelineEndpoint = (...args: any[]) => Promise<any>;
...
export interface RequestOptions {
  ...
  headers: {
    ...
    "x-youtube-identity-token"?: string | null;
  };
}
...
export type ChooseFormatQuality =
  | "lowest"
  | "highest"
  | "highestaudio"
  | "lowestaudio"
...
export type VideoFormatQuality =
  | "tiny"
  | "small"
  | "medium"
  | "large"
...
export interface VideoFormat {
  ...
  container: string | null | "flv" | "3gp" | "mp4" | "webm" | "ts";
  hasVideo: boolean;
  hasAudio: boolean;
  codecs: string | null;
...
export type CaptionTrackSimpleText =
  | "Afrikaans"
  | "Albanian"
  | "Amharic"
  | "Arabic"
...
export type CaptionTrackLanguageCode =
  | "af"
  | "sq"
  | "am"
  | "ar"
