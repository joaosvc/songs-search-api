...
exports.GetPlaylistSongsController = void 0;
const tslib_1 = require("tslib");
const helpers_1 = require("../helpers");
const parser_1 = tslib_1.__importDefault(require("../../utils/parser"));
class GetPlaylistSongsController {
    handle(httpRequest) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const metadata = yield parser_1.default.searchPlaylistSongs(playlistId, offset, limit);
...
exports.GetPlaylistSongsController = GetPlaylistSongsController;
